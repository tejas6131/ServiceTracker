  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {errors.partName ? <HelperText type="error">{errors.partName}</HelperText> : null}
        ...
        <DatePickerField
          ...
          onChange={setDateOfReplacement}
          error={!!errors.dateOfReplacement}
        />
        {errors.dateOfReplacement ? <HelperText type="error">{errors.dateOfReplacement}</HelperText> : null}

        <TextInput label="Odometer Reading" placeholder="e.g. 82000 Km" value={odometerReading} onChangeText={setOdometerReading} mode="outlined" style={styles.input} />
        <TextInput label="Replaced At" placeholder="e.g. Local Garage, Pune" value={replacedAt} onChangeText={setReplacedAt} mode="outlined" style={styles.input} />
        <TextInput label="Cost (₹)" placeholder="e.g. 2500" value={cost} onChangeText={setCost} mode="outlined" style={styles.input} keyboardType="numeric" />
        <TextInput label="Warranty" placeholder="e.g. 6 months" value={warranty} onChangeText={setWarranty} mode="outlined" style={styles.input} />
        <TextInput label="Notes" placeholder="Any additional remarks" value={notes} onChangeText={setNotes} mode="outlined" style={styles.input} multiline numberOfLines={3} />
